...
const prefixes={sqlite:'sqlite worker isolation ok',peer:'peer run admission ok',foreground:'foreground cancel ok',orchestration:'orchestration integrated ok',whatsapp:'whatsapp subagent e2e ok',pipeline:'pipeline seam ok',children:'subagents integration ok',jobs:'subagent integration ok',policy:'isolated policy ok'};
